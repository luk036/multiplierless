...
Welcome to `multiplierless` contributor's guide.
...
If you experience bugs or general issues with `multiplierless`, please have a look
...
You can help improve `multiplierless` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`multiplierless` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `multiplierless`'s files. While this mechanism can
...
```
conda create -n multiplierless python=3 six virtualenv pytest pytest-cov
conda activate multiplierless
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/multiplierless.git
   cd multiplierless
   ```
...
5. Install [pre-commit]:
   ...
   `multiplierless` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/multiplierless
[issue tracker]: https://github.com/<USERNAME>/multiplierless/issues
